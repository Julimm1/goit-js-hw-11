...
//   fetch(queryValue) // робимо запит на пошук 
//     .then(renderGallery) // відмальовка карточки знайденого 
//     .catch(onFetchError) // оброблюємо помилку якщо  не знайдено з інформуванням користувача про це
//     .finally(() => searchForm.reset());// Очищення галереї
